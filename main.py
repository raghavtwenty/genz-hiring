...
from export_pdf import create_resume_pdf
...
def generate_pdf():
    data = request.form
    pdf_filename = "boiz_genz_new_resume.pdf"
    create_resume_pdf(magic, pdf_filename)

    return render_template("generatedpdf.html")
